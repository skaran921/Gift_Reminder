...
class _DashBoardState extends State<DashBoard> {
  ...
  void deleteTransaction(BuildContext context,
    ...
    CustomAlertBox.showConfirmBox(
        context: context,
        title: "Delete",
        isLoading: GiftAppBloc().isRemoveTransactionLoading,
        content: BlocBuilder(
          ...
          child: Column(
            children: <Widget>[
              ...
              Container(
                ...
                child: GiftAppBloc().allTransaction.length == 0
                    ? Column(
                                ...
                                child: ExpansionTile(
                                  ...
                                  children: [
                                    ...
                                    ListTile(
                                      ...
                                      subtitle: CustomText(
                                          text:
                                              "${GiftAppBloc().allTransaction[index]['BOOK_NUMBER']}"),
                                      trailing: Column(
                                        mainAxisSize: MainAxisSize.min,
                                        children: [
                                    ...
                                    ListTile(
                                      ...
                                      subtitle: CustomText(
                                          text: ConvertDate.seprateDataAndTime(
                                              "${GiftAppBloc().allTransaction[index]['CREATE_DATE']}")),
                                    ),
                                  ],
                                ),
                              ),
